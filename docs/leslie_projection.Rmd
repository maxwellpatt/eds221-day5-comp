...
# Generates a sequence from 0 to 8 counting by 1, for each year
time_yr <- seq(from = 0, to = 8, by = 1)

# Generates a matrix for the values of fish in each category 
proj_year <- matrix(ncol = length(fish_year0), nrow = length(time_yr))

# Projects fish for the next year with current information
proj_year[1, ] <- fish_year0

# Projects fish for the rest of the years, up until year 8 based on time_yr
